...
# isole s2
# _ = to.animate([[G_, ps2.point, r4.point, ps1.point], [P, s1.origin]], list_vectors=[(r2.point, -r2.force), (ps2.point, -ps2.normal * z_cross(unit(_ps2.s1.angle + _ps1.a1))), (r3.point, r3.force), (gear.contact_point, -gear.contact_force)], vector_scale=1)
# isole s1
_ = to.animate([[G_, ps2.point, r4.point, ps1.point], [P, s1.origin]], list_vectors=[(r1.point, -r1.force), (gear.contact_point, gear.contact_force)], vector_scale=1)
