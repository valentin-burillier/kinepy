...
# sys.add_gear_rack(r1, p1, pressure_angle=np.pi/8)
...
plt.plot(angle, r1.get_force(), label="Force1") # valeur en X ok mais en Y devrait être -7.5, 0, +7.5 (Couple_D/r2*(r2 - r1)/a = 15/0.4*0.2/1)  (* 2) r vs D ! -> 2/D = 1/r2 OK, mais D - d = 2 * (r2 - r1)
plt.plot(angle, r2.get_force(), label="Force2") # valeur en X ok mais en Y devrait être 37.5, 30, 22.5 (30 - y_force_r1)
plt.legend()
plt.show()
